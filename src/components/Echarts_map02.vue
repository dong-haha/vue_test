<template>
  <div id="my_echarts_map02"  style="width:600px;height:600px;"></div>
</template>
...
export default {
  ...
  methods: {
    drawLine(){
			...
			var chartDom = document.getElementById('my_echarts_map02');
			var myChart = echarts.init(chartDom);
			var option;
            this.$http.get(ROOT_PATH + '/data/asset/geo/Beef_cuts_France.svg')
            .then(function (svg) {
